...
public enum ErrorCode {
    ...
    CANNOT_ADD_OWNER_AS_PARTICIPANT("E_400_002", HttpStatus.BAD_REQUEST, "작성자는 참여자로 추가할 수 없습니다."),
    PARTICIPANT_NOT_FOUND("E_404_002", HttpStatus.NOT_FOUND, "참여자를 찾을 수 없습니다."),
    USER_NOT_FOUND("E_404_003", HttpStatus.NOT_FOUND, "사용자를 찾을 수 없습니다."),
    INVALID_STATUS_TRANSITION("E_409_004", HttpStatus.CONFLICT, "현재 상태에서는 요청한 상태로 변경할 수 없습니다."),
    SAME_STATUS_TRANSITION("E_409_005", HttpStatus.CONFLICT, "이미 요청한 상태입니다."),
    PARTICIPANT_ALREADY_EXISTS("E_409_006", HttpStatus.CONFLICT, "이미 참여 중인 사용자입니다."),
    SCHEDULE_DELETE_NOT_ALLOWED("E_409_007", HttpStatus.CONFLICT, "예정 상태의 일정만 삭제할 수 있습니다."),
