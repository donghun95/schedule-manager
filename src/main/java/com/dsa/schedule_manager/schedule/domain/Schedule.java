...
public class Schedule extends BaseEntity {
    ...
    private Schedule(Long ownerId, String title, String description,
    ...
    public static Schedule create(Long ownerId, String title, String
            description, LocalDateTime scheduledAt) {
        return new Schedule(ownerId, title, description, scheduledAt);
    }
    public void update(String title, String description, LocalDateTime
            scheduledAt) {
